  ...
  if (client) {
    ...
    if (client.available()) {
      ...
      if (buggyfollow) {
        ...
        // Set motor directions based on line-following logic
        ...
        // Apply PWM speed from PID output (AFTER setting direction)
...
void travel_dist(WiFiClient client) {
  float revolutions = pulseCount / 8;
